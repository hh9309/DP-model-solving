...
1. **\u72B6\u6001\u7A7A\u95F4\u4E0E\u526A\u679D\u5206\u6790**\uFF1A\u5206\u6790\u5F53\u524D\u72B6\u6001\u7A7A\u95F4\u89C4\u6A21\uFF08\u5982 N\xD7W \u6216 N\xD7M\uFF09\u3002\u5206\u6790\u672C\u95EE\u9898\u662F\u5426\u5B58\u5728\u53EF\u526A\u679D\u6216\u63D0\u65E9\u9000\u51FA\u7684\u5206\u652F\uFF1F\u5982\u4F55\u964D\u4F4E\u5B9E\u9645\u8FD0\u884C\u65F6\u7684\u5E38\u6570\u590D\u6742\u5EA6\uFF1F
...
function getHeuristicInsight(problemType, params, dpTable, backtrackingPath) {
  if (problemType === "knapsack") {
    const weights = params.weights || [];
    const values = params.values || [];
    const capacity = params.capacity || 0;
    const hasNegative = weights.some((w) => w < 0) || values.some((v) => v < 0);
...
* **\u7279\u6B8A\u8FB9\u754C\u8B66\u544A**\uFF1A${zeroCapacity ? "\u26A0\uFE0F **\u96F6\u5BB9\u91CF\u8B66\u544A**\uFF1A\u5F53\u524D\u80CC\u5305\u5BB9\u91CF\u4E3A 0\uFF0C\u6700\u4F18\u89E3\u663E\u7136\u4E3A 0\uFF0CDP \u72B6\u6001\u8868\u5C06\u5168\u4E3A 0\uFF0C\u5C5E\u4E8E\u9000\u5316\u7684\u8FB9\u7F18\u7528\u4F8B\u3002" : "\u{1F4A1} \u6781\u7AEF\u60C5\u51B5\uFF1A\u5982\u679C $W$ \u6781\u5927\uFF08\u4F8B\u5982 $10^9$\uFF09\u800C $N$ \u5F88\u5C0F\uFF0C\u76F4\u63A5\u586B $O(N \\times W)$ \u7684\u8868\u4F1A\u5BFC\u81F4\u5185\u5B58\u6EA2\u51FA\uFF08MLE\uFF09\u3002\u6B64\u65F6\u5E94\u91C7\u7528**\u8D85\u5927\u80CC\u5305\u95EE\u9898**\u7684\u4F18\u5316\u7B56\u7565\uFF08\u5982\u53CC\u5411\u641C\u7D22\u6216\u57FA\u4E8E\u4EF7\u503C\u7684 DP\uFF0C\u72B6\u6001\u6570\u53D8\u4E3A $O(N \\times \\sum V)$\uFF09\u3002"}
...
### 2. \u8FB9\u754C\u4E0E\u7279\u6B8A\u8B66\u544A
* **\u6781\u7AEF\u8F93\u5165**\uFF1A${s1 === s2 ? "\u2705 **\u5B8C\u5168\u5339\u914D**\uFF1A\u4E24\u5B57\u7B26\u4E32\u5B8C\u5168\u4E00\u81F4\uFF0C\u7F16\u8F91\u8DDD\u79BB\u4E3A 0\u3002" : "\u{1F4A1} \u6B63\u5E38\u8F93\u5165\u3002\u4E24\u5B57\u7B26\u5B58\u5728\u5DEE\u5F02\uFF0C\u9700\u8981\u8FDB\u884C\u7F16\u8F91\u64CD\u4F5C\u3002"}
